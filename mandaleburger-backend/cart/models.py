...
# from core.models import CustomBurger  # <-- Descomentar cuando tengas el modelo
...
class CartItem(models.Model):
    ...
    # custom_burger = models.ForeignKey('core.CustomBurger', on_delete=models.CASCADE, null=True, blank=True)
