      ...
      {listaBurger.map((burger) => (
        ...
        >
          ...
          <div className="bg-gris-boton p-4 flex flex-col justify-between flex-1">
            <h3 className="text-base md:text-lg font-semibold text-white text-center mb-2 tracking-wider">
            ...
            <div className="flex justify-between items-center">
              ...
              <button
                ...
                className="bg-naranja-boton hover:bg-naranja-boton-hover text-white p-2 rounded-full transition-all duration-300 hover:scale-110"
              >
                <Eye size={20} />
              </button>
            </div>
