...
const AdminPromocionEditForm = () => {
  ...
  const [formData, setFormData] = useState({
    ...
    price: "",
    img: null,
    plan: "", // lo vamos a manejar después
  });
  ...
  // Precargar datos cuando promo esté disponible
  useEffect(() => {
    if (!promo) return;
    ...
    setFormData({
      ...
      price: promo.price,
      img: null, // dejamos null para poder reemplazar si cargan otra
  ...
  return (
    <div className="w-full max-w-md mx-auto mt-6 pb-25">
      ...
      <form onSubmit={handleSubmit} className="w-full flex flex-col gap-4">
        ...
        >
          {cargandoEdicion ? <Spinner /> : "Actualizar promoción"}
        </Button>
      </form>
